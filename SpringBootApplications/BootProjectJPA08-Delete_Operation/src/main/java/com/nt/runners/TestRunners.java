...
public class TestRunners implements CommandLineRunner {
    ...
    private final DoctorMgmtServiceImpl docService;

	@Autowired
	private IDoctorMgmtService dservice;

    TestRunners(DoctorMgmtServiceImpl docService) {
...
//		}
		...
		//===========================================================updation=============
//		try {
//			System.err.println(dservice.adjustDoctorSalary(953,10));
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
//		
//		try {
//			Doctor doc = new Doctor(786,"Raju Babu","Orthopeditrician",500000.0);
//			System.err.println(dservice.registerOrUpdateDoctor(doc)); // empty doctor is used
////			Doctor doc = new Doctor(50,"harshitha","Cardiologist",400000.0); // this is ignored
////			System.err.println(dservice.registerOrUpdateDoctor(doc)); // empty doctor is used
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
		
		//=============Transient take keyword or set null value=============
		//@Transient will not allow the salary not to participate persistence operation
//		try {
//			Doctor d = new Doctor();
//			d.setDocId(121);
//			d.setDocName("Prakash kumar");
//			d.setSalary(null);
//			d.setSpecialization("Physiotherapy");
//			System.err.println(dservice.registerOrUpdateDoctor(d));
//		} catch (Exception e) {
...
//		
		...
		//=================Deletion operation==============================
//		try {
//			System.err.println(dservice.removeDoctorById(400));
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
...
//			doc.setDocId(402);
//			System.err.println(dservice.deleteDoctor(doc));
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
		
		try {
			System.err.println(docService.removeDoctorsByIds(List.of(3,4)));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
